...
class PlatformWordIndex {
  ...
  static const Map<String, PageMatch> _singlePageTerms = {
    ...
    'crop health': PageMatch(navIndex: 11, pageName: 'Farm Operations', description: 'AI crop disease diagnostic scanner & field ops'),
    'pest': PageMatch(navIndex: 11, pageName: 'Farm Operations', description: 'Pest identification & treatment'),
    'disease': PageMatch(navIndex: 11, pageName: 'Farm Operations', description: 'Crop disease diagnostics'),
