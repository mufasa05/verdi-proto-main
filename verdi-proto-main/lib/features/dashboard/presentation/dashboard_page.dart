      ...
      children: [
        ...
        _buildResponsiveGrid([
          ...
          _buildControlCard(
            ...
            desc: 'Elevate or downgrade stakeholder privilege tier on demand',
            onTap: () => _openSubPage('Role Privilege Matrix', const UserIdentityControlPage()),
          ),
          _buildControlCard(
            icon: Icons.verified_user_outlined,
            title: 'Override KYC status',
            desc: 'Approve or revoke verification status without waiting for queue',
            onTap: () => _openSubPage('KYC User Verification Desk', const UserIdentityControlPage()),
          ),
          _buildControlCard(
            icon: Icons.phonelink_lock_outlined,
            title: 'Reset 2FA & credentials',
            desc: 'Recover accounts or force immediate security sign-outs',
