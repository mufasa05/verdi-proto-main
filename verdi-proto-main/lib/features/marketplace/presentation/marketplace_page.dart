...
class _MarketplacePageState extends ConsumerState<MarketplacePage>
  ...
  final List<MarketplaceProduct> _defaultProducts = const [
    ...
    MarketplaceProduct(
      ...
      category: 'More',
      description: 'NPK 7:14:7 basal dressing fertilizer (50kg).',
      price: '\$28.00 / bag',
      seller: 'AgriSupply',
      location: 'Chiredzi',
    ...
    MarketplaceProduct(
      ...
      category: 'More',
      description: 'High-nitrogen top-dressing fertilizer (50kg).',
      price: '\$32.00 / bag',
    ...
    MarketplaceProduct(
      ...
      category: 'More',
      description: 'Enriched worm casting compost for soil health.',
      price: '\$12.00 / bag',
      seller: 'EcoSoil Organics',
      location: 'Mutare',
    ...
    MarketplaceProduct(
      ...
      category: 'More',
      description: 'Solar-compatible drip irrigation system complete with valves & headers.',
      price: '\$250.00 / kit',
      seller: 'AgriSupply',
      location: 'Harare',
    ...
    MarketplaceProduct(
      ...
      category: 'More',
      description: 'Organic broad-spectrum botanical pest control (1L).',
      price: '\$14.00 / bottle',
      seller: 'Green Guard Zim',
      location: 'Chiredzi',
      quantity: '80 bottles available',
      distance: '8.0 km',
    ...
    MarketplaceProduct(
      name: 'Sorghum Grain',
      category: 'Maize',
      description: 'Red sorghum grain for milling, brewing & stockfeed.',
      price: '\$0.28 / kg',
      seller: 'Lowveld Drylands',
      location: 'Chiredzi',
      quantity: '3,500 kg available',
      distance: '16 km',
    ...
    MarketplaceProduct(
      name: 'Sugar Beans',
      category: 'Beans',
      description: 'Grade-A dried red sugar beans.',
      price: '\$1.15 / kg',
      seller: 'Birchenough Farms',
      location: 'Chipinge',
      quantity: '2,200 kg available',
      distance: '26 km',
    ...
    MarketplaceProduct(
      name: 'Papaya / Pawpaw',
      category: 'Fruits',
      description: 'Fresh red-fleshed sweet papayas.',
      price: '\$0.90 / kg',
      seller: 'Honde Valley Orchards',
      location: 'Mutare',
      quantity: '850 kg available',
      distance: '38 km',
      imageUrl: 'https://images.unsplash.com/photo-1517282009859-f000ec3b26fe?auto=format&fit=crop&w=900&q=80',
    ),
    MarketplaceProduct(
      name: 'Macadamia Nuts',
      category: 'Fruits',
      description: 'Raw macadamia nuts in shell for processors.',
      price: '\$3.80 / kg',
      seller: 'Chipinge Agro Estates',
      location: 'Chipinge',
      quantity: '1,100 kg available',
      distance: '45 km',
      imageUrl: 'https://images.unsplash.com/photo-1596560548464-f010549b84d7?auto=format&fit=crop&w=900&q=80',
    ),
    MarketplaceProduct(
      name: '75HP Utility Farm Tractor',
      category: 'More',
      description: 'Serviced 4WD diesel tractor with PTO output.',
      price: '\$8,500 / unit',
    ...
    MarketplaceProduct(
      name: '2-Row Precision Maize Planter',
      category: 'More',
      description: 'Tractor-towed precision seed & fertilizer planter.',
      price: '\$2,100 / unit',
    ...
    MarketplaceProduct(
      name: '3-Disc Heavy Duty Plough',
      category: 'More',
      description: 'Reinforced disc plough for deep tilling.',
      price: '\$680 / unit',
      seller: 'Farm Tools Hub',
      location: 'Masvingo',
      quantity: '4 units available',
      distance: '11.2 km',
      imageUrl: 'https://images.unsplash.com/photo-1592982537447-7440770cbfc9?auto=format&fit=crop&w=900&q=80',
    ),
    MarketplaceProduct(
      name: 'Solar Grain Moisture Meter',
      category: 'More',
      description: 'Handheld digital moisture analyzer for grains & seeds.',
      price: '\$85.00 / unit',
      seller: 'PrecisionAg Zim',
      location: 'Harare',
      quantity: '25 units available',
      distance: '15 km',
      imageUrl: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=900&q=80',
    ),
    MarketplaceProduct(
      name: 'Cold Storage Container Bay (20ft)',
      category: 'More',
      description: 'Rental temperature-controlled post-harvest cold room (0°C to 10°C).',
      price: '\$120.00 / day',
      seller: 'Lowveld ColdChain Ltd',
      location: 'Chiredzi',
      quantity: '4 bays available',
      distance: '5.0 km',
      imageUrl: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=900&q=80',
    ),
    MarketplaceProduct(
      name: 'Refrigerated Freight Transport',
      category: 'More',
      description: 'Cold-chain refrigerated truck delivery service for perishables.',
      price: '\$0.15 / km/ton',
      seller: 'ZimExpress Freight',
      location: 'Masvingo',
      quantity: 'Fleet on demand',
      distance: '6.2 km',
      imageUrl: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&w=900&q=80',
    ),
    MarketplaceProduct(
      name: 'Multi-Crop Hammer Mill',
      category: 'More',
      description: '15HP diesel grain mill & processor for maize meal.',
      price: '\$1,450 / unit',
      seller: 'Harare Machinery Works',
      location: 'Harare',
    ...
    MarketplaceProduct(
      name: 'Harvest Vent Crates (50L)',
      category: 'More',
      description: 'Stackable food-grade plastic crates for produce transport.',
      price: '\$6.50 / crate',
      seller: 'PolyPack Zim',
      location: 'Bulawayo',
      quantity: '400 crates available',
      distance: '14 km',
