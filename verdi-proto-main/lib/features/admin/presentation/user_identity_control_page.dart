...
class _UserIdentityControlPageState extends ConsumerState<UserIdentityControlPage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _userDatabase = [
    ...
    {
      'id': 'USR-88902',
      'name': 'Sekuru Phineas Chitate',
      'email': 'p.chitate@mazowefarms.co.zw',
      'role': 'Farmer',
      'kyc': 'VERIFIED',
      'location': 'Mazowe Ward 4 (35 Ha)',
      'eudr': 'EUDR-ZIM-2026-094',
      'status': 'ACTIVE',
      'sessions': 1,
      'lastSeen': '1 hour ago',
      'joiningDate': '20 November 2024',
      'phone': '+263 77 810 4492',
      'escrowBalance': 'US\$ 1,840.00',
    },
    {
      'id': 'USR-88903',
      'name': 'Tariro Hove (Nyabira Horticulture)',
      'email': 'tariro.hove@nyabirafresh.co.zw',
      'role': 'Farmer',
      'kyc': 'VERIFIED',
      'location': 'Nyabira / Zvimba (45 Ha)',
      'eudr': 'EUDR-ZIM-2026-105',
      'status': 'INACTIVE',
      'sessions': 0,
      'lastSeen': '5 days ago',
      'joiningDate': '12 February 2025',
      'phone': '+263 71 330 9912',
      'escrowBalance': 'US\$ 890.00',
    },
    ...
    {
      'id': 'USR-99215',
      'name': 'Grain Marketing Board Wholesale Desk',
      'email': 'intake.procure@gmb.co.zw',
      'role': 'Commercial Buyer (B2B)',
      'kyc': 'VERIFIED',
      'location': 'Workington Central Depot',
      'eudr': 'EUDR-ZIM-2026-GMB',
      'status': 'ACTIVE',
      'sessions': 3,
      'lastSeen': '30 mins ago',
      'joiningDate': '15 August 2024',
      'phone': '+263 24 270 4511',
      'escrowBalance': 'US\$ 45,000.00',
    },
    {
      'id': 'USR-99216',
      'name': 'National Foods Procurement Ltd',
      'email': 'grain@natfoods.co.zw',
      'role': 'Commercial Buyer (B2B)',
      'kyc': 'PENDING',
      'location': 'Harare Heavy Industrial',
      'eudr': 'EUDR-NAT-2026',
      'status': 'PENDING',
      'sessions': 1,
      'lastSeen': 'Yesterday',
      'joiningDate': '22 August 2026',
      'phone': '+263 24 275 3900',
    ...
    {
      'id': 'USR-30111',
      'name': 'Rutendo Chiweshe',
      'email': 'rutendo.c@gmail.com',
      ...
      'phone': '+263 77 551 2290',
      'escrowBalance': 'US\$ 65.00 (EcoCash Wallet)',
    },
    {
      'id': 'USR-30112',
      'name': 'Samantha Ndlovu',
      'email': 'sam.ndlovu@yahoo.com',
      'role': 'Consumer (End-User)',
      'kyc': 'VERIFIED',
      ...
      'sessions': 0,
      'lastSeen': '8 days ago',
      'joiningDate': '01 April 2025',
      'phone': '+263 71 880 1123',
      'escrowBalance': 'US\$ 12.50',
    },
    {
      'id': 'USR-30113',
      'name': 'Brian Matarise',
      'email': 'brian.matarise@outlook.com',
      'role': 'Consumer (End-User)',
      'kyc': 'PENDING',
      ...
      'joiningDate': '14 May 2025',
      'phone': '+263 77 999 1234',
      'escrowBalance': 'US\$ 0.00',
    },
    ...
    {
      'id': 'USR-44103',
      'name': 'Southern Cross Refrigerated Logistics',
      'email': 'ops@southerncross.co.zw',
      'role': 'Transporter',
      'kyc': 'VERIFIED',
      'location': 'Harare - Mutare Transit Corridor',
      'eudr': 'EUDR-LOG-902',
      'status': 'ACTIVE',
      'sessions': 4,
      'lastSeen': '10 mins ago',
      'joiningDate': '05 November 2024',
      'phone': '+263 78 200 4411',
      'escrowBalance': 'US\$ 6,400.00',
    },
    {
      'id': 'USR-44104',
      'name': 'Swift Agri-Haulage Ltd',
      'email': 'compliance@swiftagri.co.zw',
      'role': 'Transporter',
      'kyc': 'PENDING',
      'location': 'Bulawayo Depot',
      'eudr': 'EUDR-LOG-PENDING',
      'status': 'SUSPENDED',
      'sessions': 0,
      'lastSeen': '1 month ago',
      'joiningDate': '10 January 2025',
      'phone': '+263 29 288 1000',
      'escrowBalance': 'US\$ 0.00',
    },
    ...
    {
      'id': 'USR-55001',
      'name': 'Dr. Nyasha Sibanda',
      'email': 'dr.sibanda@agri-sovereign.org',
      'role': 'Agri-Expert',
      'kyc': 'VERIFIED',
      'location': 'Mashonaland West (ZAPB-LIC-2014)',
      'eudr': 'EUDR-EXP-994',
      'status': 'ACTIVE',
      'sessions': 6,
      'lastSeen': 'Just now',
      'joiningDate': '01 September 2024',
      'phone': '+263 77 412 9081',
      'escrowBalance': 'US\$ 3,450.00',
    },
    {
      'id': 'USR-55002',
      'name': 'Evelyn Moyo (Agritex Extension Officer)',
      'email': 'e.moyo@lands.gov.zw',
      'role': 'Agri-Expert',
      'kyc': 'VERIFIED',
      'location': 'Mutare District (Wards 12-14) • Verified by State',
      'eudr': 'AGX-ZW-2026-0021',
      'status': 'ACTIVE',
      'sessions': 2,
      'lastSeen': 'Today',
      'joiningDate': '12 October 2024',
      'phone': '+263 77 201 3344',
      'escrowBalance': 'N/A (State Extension)',
    },
    {
      'id': 'USR-55003',
      'name': 'Tatenda Mushonga (Corporate Agronomist)',
      'email': 't.mushonga@seedco.co.zw',
      'role': 'Agri-Expert',
      'kyc': 'VERIFIED',
      'location': 'SeedCo Outgrower Scheme Block #12',
      'eudr': 'SC-AGR-4491',
      'status': 'ACTIVE',
      'sessions': 3,
      ...
      'escrowBalance': 'US\$ 1,200.00',
    },
    {
      'id': 'USR-55004',
      'name': 'Dr. Tendai Hove',
      'email': 't.hove@botanical-diagnostics.co.zw',
      'role': 'Agri-Expert',
      'kyc': 'PENDING',
      'location': 'Harare Research Lab',
      'eudr': 'EXP-PENDING-901',
      'status': 'PENDING',
      'sessions': 0,
      'lastSeen': '2 days ago',
      'joiningDate': '23 August 2026',
      'phone': '+263 77 662 1099',
      'escrowBalance': 'US\$ 0.00',
    },
    ...
    {
      'id': 'USR-77001',
      'name': 'Olivine Oil Processing Industries',
      'email': 'procure@olivine.co.zw',
      'role': 'Value Adder',
      'kyc': 'VERIFIED',
      'location': 'Harare Industrial Sites (Soybean Crushing)',
      'eudr': 'VAL-OLI-2026',
      'status': 'ACTIVE',
      'sessions': 2,
      'lastSeen': '3 hours ago',
      'joiningDate': '12 January 2025',
      'phone': '+263 24 275 4000',
      'escrowBalance': 'US\$ 34,200.00',
    },
    {
      'id': 'USR-77002',
      'name': 'Tanganda Tea Packers Ltd',
      'email': 'factory@tanganda.co.zw',
      'role': 'Value Adder',
      'kyc': 'VERIFIED',
      'location': 'Chipinge / Mutare Factory',
      'eudr': 'VAL-TAN-881',
      'status': 'ACTIVE',
      'sessions': 1,
      'lastSeen': 'Yesterday',
      'joiningDate': '18 February 2025',
      'phone': '+263 20 621 00',
      'escrowBalance': 'US\$ 18,500.00',
    },

    // 🛡️ SUPER ADMINS
    {
      'id': 'USR-ROOT-01',
      'name': 'Antigravity Root Sovereign Admin',
      'email': 'admin@verdi.co',
      'role': 'Admin',
      'kyc': 'VERIFIED',
      'location': 'Verdi Core Data Center (Primary Node)',
      'eudr': 'ROOT-AUTH-999',
      'status': 'ACTIVE',
      'sessions': 8,
      'lastSeen': 'Just now',
      ...
      'escrowBalance': 'US\$ 0.00 (Admin Node)',
    },
  ];
          ...
          Row(
            children: [
              Expanded(
                child: TextField(
                  decoration: InputDecoration(
                    hintText: 'Search user directory by name, email, role, or ID...',
              ...
              _dropdownFilter(
                'Status',
                _selectedKycFilter,
                ['All KYC Status', 'VERIFIED', 'PENDING'],
                (v) => setState(() => _selectedKycFilter = v),
              ),
            ],
          ),
          const SizedBox(height: 12),

          // Horizontal Role Category Filter Chips
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                final count = roleName == 'All Roles'
                    ? users.length
                    : users.where((u) => u['role'] == roleName).length;
                ...
                return Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    backgroundColor: cardDark,
                    onSelected: (_) => setState(() => _selectedRoleFilter = roleName),
                  ),
                );
              }).toList(),
            ),
